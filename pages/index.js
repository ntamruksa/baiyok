      ...
      <section className='section section-aboutus'>
        ...
        <Row className='mx-4'>
          <Col sm={6} xs={12} className='my-4'>
            ...
            <p className='paragraph'>
              In 2001, our family established Bai Yok Castlecrag with an aim to
              become part of the Castlecrag community. Since then we have been
              creating quality authentic Thai food, just as we would do for our
              own family. We can always recall our opening night and especially
              the first couple that stepped into our restaurant, They have not
              just become our regular customer, but also part of our extended
              Castlecrag family.
            </p>
            <p className='paragraph'>
              Due to the community support and patronage, Bai Yok Castlecrag has
              now been operating over 19 years. We appreciate the community that
              see us as the go to "dining venue" and will continue to deliver
              exciting, quality authentic Thai cuisine at Bai Yok Castlecrag.
            </p>
            <p className='paragraph'>
